...
class FaceView: UIView {
    ...
    private var skullRadius: CGFloat {
        // don't use frame here! Frame is from the point-of-view of the superView
    ...
    private func pathForBrow(eye: Eye) -> UIBezierPath {
        ...
        let browStart = CGPoint(x: browCenter.x - eyeRadius/2, y: browCenter.y - tiltOffset)
        let browEnd = CGPoint(x: browCenter.x + eyeRadius/2, y: browCenter.y + tiltOffset)
        let path = UIBezierPath()
